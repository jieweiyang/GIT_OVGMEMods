...
materials["HUD_IND_TST"]         = {  0, 255,   0,   4}
materials["HUD_IND_TST2"]        = {255, 255,   0,   4}

-- MFCDs
materials["MFCD_IND_DEF"]        = {  0, 255,   0, 255}
materials["MFCD_IND_RED"]        = {255,   0,   0, 240}
materials["MFCD_IND_GREEN"]      = {  0, 255,   0, 255}  -- Level 150
materials["MFCD_IND_DGREEN"]     = {  3,  67,  40, 255}  -- Level 240
materials["MFCD_IND_BLUE"]       = {  0,   0, 255, 240}
materials["MFCD_IND_BLUE_L"]     = {70, 130, 180, 255}
materials["MFCD_IND_BLACK"]      = {  0,   0,   0, 240}
materials["MFCD_IND_DARK"]       = {  0,   0,   0, 128} -- Level 128
...
textures["hud_mesh_tst"]         = {nil, materials["HUD_IND_TST"]}
textures["hud_mesh_tst2"]        = {nil, materials["HUD_IND_TST2"]}
