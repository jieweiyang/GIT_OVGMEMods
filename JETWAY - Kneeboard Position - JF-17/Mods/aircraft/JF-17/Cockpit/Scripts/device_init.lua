...
-- CONTROL_INDICATOR
creators[devices.CTRL_IND]        = {"avLuaDevice", script_path .. "ControlsIndicator/ControlsIndicator_data.lua", {}}
...
-- imGUI debug window
indicators[#indicators + 1] = {"DEKA_Device::JF_17::ccDebugWin", script_path .. "DebugWindow/DebugWindow_page_init.lua"}

-- throttle/rudder/pitch/bank/brake/flaps/gears
indicators[#indicators + 1] = {"ccIndicator", script_path .. "ControlsIndicator/ControlsIndicator_page_init.lua"}
