...
local 			init_script = LockOn_Options.common_script_path.."KNEEBOARD/indicator/init_Resize.lua"
if is_left then init_script = LockOn_Options.common_script_path.."KNEEBOARD/indicator/init_left_Resize.lua" end
