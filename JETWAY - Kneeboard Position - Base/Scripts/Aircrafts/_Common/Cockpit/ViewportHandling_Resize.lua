...
function update_screenspace_diplacement(aspect,is_left,zoom_value)
	...
	local kneeboard_lx=10			--膝板左上角 X 坐标
	local kneeboard_ty=1440+140		--膝板左上角 Y 坐标
	local kneeboard_width=768-20	--膝板显示宽度
	local kneeboard_height=755		--膝板显示高度

	dedicated_viewport 		  = {kneeboard_lx,kneeboard_ty,kneeboard_width,kneeboard_height}
